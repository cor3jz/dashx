...
class VoyagerServiceProvider extends ServiceProvider
{
    ...
    private function registerPublishableResources()
    {
        ...
        $publishable = [
            ...
            'lang' => [
                "{$publishablePath}/lang/" => resource_path('lang/backend/dashx'),
            ],
    ...
    public function loadAuth()
    {
        ...
        try {
            ...
            Log::info('Еще нет подключения к БД в VoyagerServiceProvider loadAuth(). Все нормально, это не проблема!');
        }
